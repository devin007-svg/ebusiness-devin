    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                ...
                <p>Selamat datang di <strong>halaman user</strong> aplikasi e-business kamu.</p>
                <p class="mt-2">Role Anda: <span class="font-semibold text-green-600">{{ Auth::user()->role }}</span></p>
